...
import sfllhkhan95.game.kaptaansquest.model.objects.GameObject;
import sfllhkhan95.game.kaptaansquest.model.objects.Ladder;
import sfllhkhan95.game.kaptaansquest.model.objects.Snake;
...
public class Board {
    ...
    void moveOnBoard(@NotNull final GameCharacter character, final Animation.AnimationListener onMotionEnd) {
