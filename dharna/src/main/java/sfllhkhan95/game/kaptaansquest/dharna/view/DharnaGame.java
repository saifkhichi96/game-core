...
import sfllhkhan95.game.kaptaansquest.dharna.Game;
import sfllhkhan95.game.kaptaansquest.dharna.R;
import sfllhkhan95.game.kaptaansquest.dharna.model.Difficulty;
import sfllhkhan95.game.kaptaansquest.dharna.model.characters.GameCharacter;
import sfllhkhan95.game.kaptaansquest.dharna.model.characters.HumanCharacter;

public class DharnaGame extends Activity {
    ...
    private class GameSetup implements GameStartListener {
        ...
        public void init() {
            ...
            if (isKaptaan) {
                game.setPlayer(new HumanCharacter(DharnaGame.this, R.id.kaptaan, R.id.scoreSharif, R.id.labelSharif));
                game.setOpponent(new GameCharacter(DharnaGame.this, R.id.sharif, R.id.scoreKaptaan, R.id.labelKaptaan));
            } else {
                game.setPlayer(new HumanCharacter(DharnaGame.this, R.id.sharif, R.id.scoreKaptaan, R.id.labelKaptaan));
                game.setOpponent(new GameCharacter(DharnaGame.this, R.id.kaptaan, R.id.scoreSharif, R.id.labelSharif));
            }
    ...
    private class GameOver implements GameOverListener {
        ...
        public void onGameOver() {
            ...
            if (difficulty.getLevel() >= 5) {
                startActivity(new Intent(DharnaGame.this, DharnaResult.class));
                finish();
            }
            ...
            // If not all levels completed, updated progress
                ...
                if (game.getWinner().equals(game.getPlayer())) {
                    Toast.makeText(DharnaGame.this, "Player won the round!", Toast.LENGTH_SHORT).show();
                    ...
                    if (p >= 100) {
                        Toast.makeText(DharnaGame.this, "Level up!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(DharnaGame.this, "Computer won the round!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
